...
module.exports = {
   ...
   // gripper_serialNr:'1111111',
    ...
    robot_halted_at_startup: 'true',//false, // save in GLOBALS.ROBOT_HALTED
    ...
    sleeptimedrop: 3,  // waiting at drop to release the car after gripper opened
    ////////////////////////////////////////////////////////////
    // Cassette Pick up ////////////////////////////////////////
    ...
    safetyZOffset: 0.010,   // Safety margin for pointing and picking from cassettes, [m] (0.05 for safe testing)
