// MACHINE 11.3 MADINAH CALIBRATION
...
module.exports = {
    ...
    calibrationAngleDEG: -0, // Front view calibration angle [degrees]
    ...
    drop1Over: {
        base: 139.9 * Math.PI / 180,
        shoulder: -156.26 * Math.PI / 180,
        elbow: -20.69 * Math.PI / 180,
        wrist1: -92.3 * Math.PI / 180,
        wrist2: 91.95 * Math.PI / 180,
        wrist3: -46.98 * Math.PI / 180
    },

    drop1Rotate: {
        base: 140.04 * Math.PI / 180,
        shoulder: -164.64 * Math.PI / 180,
        elbow: -2.8 * Math.PI / 180,
        wrist1: -105.4 * Math.PI / 180,
        wrist2: 94.26 * Math.PI / 180,
        wrist3: -78.2 * Math.PI / 180
    },

    drop1Release: {
        base: 140.22 * Math.PI / 180,
        shoulder: -155.59 * Math.PI / 180,
        elbow: -20.93 * Math.PI / 180,
        wrist1: -96.3 * Math.PI / 180,
        wrist2: 94.26 * Math.PI / 180,
        wrist3: -78.01 * Math.PI / 180
    },
    ...
    drop2Rotate: {
        base: 136.92 * Math.PI / 180,
        shoulder: -142.66 * Math.PI / 180,
        elbow: -47.74 * Math.PI / 180,
        wrist1: -75.08 * Math.PI / 180,
        wrist2: 92.13 * Math.PI / 180,
        wrist3: -88.69 * Math.PI / 180
    },

    drop2Release: {
        base: 136.94 * Math.PI / 180,
        shoulder: -140.3 * Math.PI / 180,
        elbow: -52.28 * Math.PI / 180,
        wrist1: -72.9 * Math.PI / 180,
        wrist2: 92.12 * Math.PI / 180,
        wrist3: -88.66 * Math.PI / 180
    },
