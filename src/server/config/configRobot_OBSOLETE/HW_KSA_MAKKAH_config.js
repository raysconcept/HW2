// MACHINE 11.5 MAKKAH CALIBRATION
...
module.exports = {
    ...
    PICK_MOVE_IN_DISTANCE: 55 / 1000,   // Distance in meters to move in from hover position [m]
    ...
    drop1To: {
        base: 135.6 * Math.PI / 180,
        shoulder: -159.18 * Math.PI / 180,
        elbow: -12.71 * Math.PI / 180,
        wrist1: -89.14 * Math.PI / 180,
        wrist2: 102.77 * Math.PI / 180,
        wrist3: -49.3 * Math.PI / 180
    },

    drop1Over: {
        base: 136.5 * Math.PI / 180,
        shoulder: -148.14 * Math.PI / 180,
        elbow: -34.23 * Math.PI / 180,
        wrist1: -91.76 * Math.PI / 180,
        wrist2: 92.63 * Math.PI / 180,
        wrist3: -78.05 * Math.PI / 180
    },

    drop1Rotate: {
        base: 137.02 * Math.PI / 180,
        shoulder: -140.53 * Math.PI / 180,
        elbow: -48.62 * Math.PI / 180,
        wrist1: -74.96 * Math.PI / 180,
        wrist2: 90.34 * Math.PI / 180,
        wrist3: -75.78 * Math.PI / 180
    },

    drop1Release: {
        base: 136.27 * Math.PI / 180,
        shoulder: -145.41 * Math.PI / 180,
        elbow: -41.15 * Math.PI / 180,
        wrist1: -87.75 * Math.PI / 180,
        wrist2: 94.55 * Math.PI / 180,
        wrist3: -84.22 * Math.PI / 180
    },
